...
class StreetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create street" do
    assert_difference("Street.count") do
      post streets_url, params: { street: { city: @street.city, country_id: @street.country_id, location: @street.location, street_name: @street.street_name } }
    end
  ...
  test "should update street" do
    patch street_url(@street), params: { street: { city: @street.city, country_id: @street.country_id, location: @street.location, street_name: @street.street_name } }
